...
namespace PwdKeychain.Interfaces
{
    ...
    {
        void AddPassword(string website, string username, string? password, string? type);
        void EditPassword(string passId, string website, string username, string? password, string? type);
